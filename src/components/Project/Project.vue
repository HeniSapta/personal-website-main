    ...
    <div class="col-lg-11 col-xl-9 col-xxl-8">
        ...
        <div class="card-body p-0">
          <div class="row">
            <div class="col-md-6 p-5">
              <h2 class="fw-bolder">Machine Learning</h2>
              <p>Analisis sentimen opini publik terhadap UU TPKS menggunakan TF-IDF dan machine learning dengan akurasi terbaik 85,35% pada Random Forest dan SVM.</p>
              <div style="margin-bottom: 15px;">
                <a href="https://bit.ly/GoogleColabJurnal" class="text-gradient text-decoration-none" target="_blank">https://colab.research.google.com/drive/17YpDZZtSXlmDji0Lmf64GYldUCt8AyQz?usp=sharing</a>
              </div>
              <div>
                <a href="https://bit.ly/DOIJurnalJAIC" class="text-gradient text-decoration-none" target="_blank">https://doi.org/10.30871/jaic.v9i6.11503</a>
              </div>
      ...
      <div class="card overflow-hidden shadow rounded-4 border-0 mb-5">
        <div class="card-body p-0">
          <div class="row">
            <div class="col-md-6 p-5">
              <h2 class="fw-bolder">Data Analytics Capstone Project</h2>
      ...
      <div class="card overflow-hidden shadow rounded-4 border-0 mb-5">
        <div class="card-body p-0">
          <div class="row">
            <div class="col-md-6 p-5">
              <h2 class="fw-bolder">Analisis Faktor Risiko Penyakit Jantung</h2>
